  ...
  return (
    ...
    <div className="w-64 mb-10">
      ...
      <div className="bg-blue-100 p-5  rounded-xl">
        {/* <Image src={picture} alt={name} width/> */}
      ...
      <p className="text-sm  mt-1 leading-1 text-gray-600 mb-6">{description}</p>
      <div className="flex  mt-1">
        <div className="text-3xl font-bold text-gray-900 dark:text-white  justify-between flex grow items-center">
          ${price}
          <button
            onClick={addProduct}
